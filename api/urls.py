...
from .views import MovementReportView, InventoryReportView, SupplierReportView, InventoryExcelReportView
...
urlpatterns = [
    ...
    path('reports/excel/', InventoryExcelReportView.as_view(), name='excel-report'),
]
